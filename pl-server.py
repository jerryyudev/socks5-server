...
# 新的函数，用于判断是否是 chatgpt.com, github.com, www.netflix.com 或者 www.disneyplus.com
def is_special_domain(domain):
    special_domains = ['chatgpt.com', 'github.com', 'www.netflix.com', 'www.disneyplus.com']
    return domain in special_domains
...
def handle_client(client_socket):
    try:
        ...
        if cmd == 1:  # 如果是 CONNECT 请求
            ...
            # 第4步：根据目标地址选择代理方式
            if is_special_domain(domain):
                # 如果是 chatgpt.com, github.com, www.netflix.com 或 www.disneyplus.com，使用中转代理
